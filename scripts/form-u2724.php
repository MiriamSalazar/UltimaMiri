...
function emailFormSubmission()
{
	...
	$subject = 'Envío de Page Master Form';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U2737"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U2725"],ENT_COMPAT,'UTF-8') . '</td></tr>';
